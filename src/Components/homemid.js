        ...
        <div className={classes.mainDiv}>
            ...
            <Grid container spacing={2} columns={12} className={classes.grid}>
                <Grid item xs={12} sm={6} className={classes.gridItem}>
                    <div className={classes.cont}><img src={headerImage} className={classes.headerImage} alt='hi'/></div>
                </Grid>
                <Grid item xs={12} sm={6}>
                    <Grid container spacing={0} columns={12} className={classes.textCont}>
                        <Grid item xs={12}>
                            <div className={classes.descDiv}>
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores labore sapiente hic numquam esse corporis id, itaque inventore omnis. Nemo aliquid sit aut veritatis aliquam maiores maxime sequi voluptatibus repudiandae?
                            </div>
                        </Grid>
                        <Grid item xs={12}>
                            <div className={classes.descDiv}>
